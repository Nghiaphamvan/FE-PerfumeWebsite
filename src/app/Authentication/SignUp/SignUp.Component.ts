...
@Component({
    ...
    constructor(private checkmethod: checkMethod,  private myService: MyService, private sharedata: DataService){}
    ...
    ActiveSignUp() {
        if(this.FirstName != null && this.FirstName != null 
            && this.checkvalidEmail && this.checkValidPassword && this.checkvalidConfirmPassword
        ) {
